...
- **사번**: 직원 사번 (문자열로 처리)
- **이름**: 직원 이름
- **생년월일**: 8자리 숫자 형식 (예: `19970919`) 또는 YYYY-MM-DD 형식 (예: `1997-09-19`)
- **부서**: 부서명

**중요**: 생년월일은 8자리 숫자 형식(`19970919`)을 권장합니다. 프로그램은 이 값을 오늘 날짜 기준으로 만 나이로 자동 계산합니다.
...
6. 얼굴 촬영 후 AI 분석 (또는 시뮬레이션 모드에서 랜덤 값)
7. 결과 화면에 실제 나이와 얼굴 나이 비교 표시
8. 동안일 경우 팡파레 효과 표시
